...
/* package smatrix-0.1.0.0 */
#ifndef VERSION_smatrix
#define VERSION_smatrix "0.1.0.0"
#endif /* VERSION_smatrix */
#ifndef MIN_VERSION_smatrix
#define MIN_VERSION_smatrix(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_smatrix */
...
#define CURRENT_COMPONENT_ID "smatrix-0.1.0.0-inplace-smatrix"
